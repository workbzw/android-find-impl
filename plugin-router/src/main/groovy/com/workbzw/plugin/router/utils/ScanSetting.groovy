...
class ScanSetting {
     ...
     */
    static final String GENERATE_TO_CLASS_NAME = 'com/workbzw/lib/base/ServiceManager'
    static final String ROUTING_TABLE = 'com/workbzw/lib/base/IRoutingTable'
    /**
     ...
     */
    static final String GENERATE_TO_METHOD_NAME = 'routingTable'
    /**
     * The package name of the class generated by the annotationProcessor
     */
    static final String ROUTER_CLASS_PACKAGE_NAME = 'com/workbzw/android/router/service'
    static final String ROUTER_TABLE_CLASS_PRE = 'com/workbzw/android/router/service/Router$$Table$$'
    /**
